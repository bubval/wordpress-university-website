...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>INF270</strong> Website</a></h1>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <li <?php if(get_post_type() == 'campus') echo' class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('campus');?>">Locations</a></li>
